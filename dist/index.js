                    ...
                    case 'load_midi_file':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await LoadMidiFileTool.execute(args), null, 2),
                                },
                            ],
                        };
                    case 'get_midi_summary':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await GetMidiSummaryTool.execute(args), null, 2),
                                },
                            ],
                        };
                    case 'get_tracks_list':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await GetTracksListTool.execute(args), null, 2),
                                },
                            ],
                        };
                    case 'get_track_details':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await GetTrackDetailsTool.execute(args), null, 2),
                                },
                            ],
                        };
                    case 'get_midi_events':
                        return {
                            content: [
                                {
                                    type: 'text',
                                    text: JSON.stringify(await GetMidiEventsTool.execute(args), null, 2),
                                },
                            ],
                        };
                    default:
